    ...
    <div className="min-h-screen w-full bg-gradient-to-br from-[#1e1e1e] to-[#2d2d2d] relative overflow-hidden">      {/* Animated Background Grid */}
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8 pt-20">
        ...
        >
          ...
          >
            Transforming businesses through intelligent <span className="text-[#ff5722] font-semibold">web</span> solutions, <span className="text-[#ff5722] font-semibold">automated workflows</span>, and <span className="text-[#ff5722] font-semibold">data-driven insights</span>.
          </motion.p>
